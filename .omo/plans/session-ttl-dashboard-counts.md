# session-ttl-dashboard-counts - Work Plan
...
- Evidence: .omo/evidence/task-<N>-session-ttl-dashboard-counts.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task-1-session-ttl-dashboard-counts.<ext>
